...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        left_feet_orientation = ObsTerm(func=mdp.imu_orientation, params={"asset_cfg": SceneEntityCfg("imu_feet_left")})
        left_feet_angular_velocity = ObsTerm(func=mdp.imu_ang_vel, params={"asset_cfg": SceneEntityCfg("imu_feet_left")})
        left_feet_linear_acceleration = ObsTerm(func=mdp.imu_lin_acc, params={"asset_cfg": SceneEntityCfg("imu_feet_left")})
        
        right_feet_orientation = ObsTerm(func=mdp.imu_orientation, params={"asset_cfg": SceneEntityCfg("imu_feet_right")})
        right_feet_angular_velocity = ObsTerm(func=mdp.imu_ang_vel, params={"asset_cfg": SceneEntityCfg("imu_feet_right")})
        right_feet_linear_acceleration = ObsTerm(func=mdp.imu_lin_acc, params={"asset_cfg": SceneEntityCfg("imu_feet_right")})
...
@configclass
class BalluSingleObstacleRealImuEnvCfg(ManagerBasedRLEnvCfg): # Renamed class

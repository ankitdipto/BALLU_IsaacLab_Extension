...
from ballu_isaac_extension.ballu_assets.ballu_config import BALLU_REAL_HETERO_CFG, BALLU_REAL_CFG
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Cluster ID intentionally removed from policy observations.
        # Specialist routing is provided externally during inference/execution.
        # cluster_id = ObsTerm(func=mdp.cluster_assignment)
...
class EventCfg:
    ...
    # Cluster initialization is unnecessary when routing is external.
    # init_clusters = EventTerm(
    #     func=mdp.initialize_morphology_clusters,
    #     mode="startup"
    # )
...
@configclass
class BalluSingleObstacleHeteroEnvCfg(ManagerBasedRLEnvCfg): # Renamed class
